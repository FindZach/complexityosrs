...
enum class RockType(val level: Int, val xp: Double, val ore: Int, val nonDepleteChance: Double, val respawnTime: IntRange) {
    ...
    LOVAKITE(level = 65, xp = 10.0, ore = Items.LOVAKITE_ORE, nonDepleteChance = 0.0, respawnTime = 22..68),
    ...
    AMETHYST(level = 92, xp = 240.0, ore = Items.AMETHYST, nonDepleteChance = 25.0, respawnTime = 50..100);
